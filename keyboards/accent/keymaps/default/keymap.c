...
//LT(RAISE, KC_GRV), KC_Z,      KC_X,    KC_C,    KC_V,   KC_B,             KC_BSPC,   KC_ESC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, LT(RAISE,KC_RBRC), 
//
 ...
 */
 [_LOWER] = LAYOUT( \
  _______,  KC_F1,    KC_F2,     KC_F3,    KC_F4,    KC_F5,                           KC_F6,   KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_MINUS, \
 ...
 */
 [_RAISE] = LAYOUT( \
  ...
  _______,  KC_MINUS, _______,   _______,  _______,  _______, _______,    _______,  _______,  _______,  _______,  _______,  KC_BSLASH,  _______,\
 ...
 */
 [_ADJUST] = LAYOUT( \
  _______,  _______,  _______,   _______,  _______, _______,                        _______,  _______,  _______,  _______,  _______,  _______, \
  RGB_HUI,  RGB_HUD,  RGB_SAI,   RGB_SAD,  RGB_VAI, RGB_VAD,                        RGB_HUI,  RGB_HUD,  RGB_SAI,   RGB_SAD,  RGB_VAI, RGB_VAD, \
