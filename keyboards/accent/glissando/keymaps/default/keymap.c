 ...
 */
 [_QWERTY] = LAYOUT( \
  ...
  LCTL_T(KC_QUOTE),    KC_A,     KC_S,    KC_D,         KC_F,                   KC_G,                                              KC_H,               KC_J,     KC_K,     KC_L,      KC_SCLN,     RALT_T(KC_LBRC),\
  LT(_RAISE, KC_GRV),  KC_Z,     KC_X,    KC_C,         KC_V,                   KC_B,                                              KC_N,               KC_M,  KC_COMM,   KC_DOT,      KC_SLSH,  LT(_RAISE,KC_RBRC),\
                                          L_T_CMD_CTL,  LT(_LOWER, KC_DELETE),  LSFT_T(KC_LNG2), KC_SPC,     KC_ENT,  RSFT_T(KC_LNG1),  LT(_LOWER, KC_ESC),  KC_RGUI     \
),
 ...
 */
 [_LOWER] = LAYOUT( \
  ...
  _______,  _______, _______,  _______, _______,  _______,                                  KC_LEFT,    KC_DOWN,       KC_UP,  KC_RIGHT, _______,  _______,\
  _______,  _______, _______,  _______, _______,  _______,                               KC_PSCR,     KC_END,   KC_PGDN,  _______,   _______,  _______,\
